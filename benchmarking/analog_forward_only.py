...
# This sequence implements an analog-forward only protocol for
# an analog simulation involving a Molmer-Sorensen interaction and a
# global transverse field term.
# It also implements amplitude noise on the two parameters.

class AnalogForwardOnly(PulseSequence):
    ...
    def run_initially(self):
        ...
        self.set_subsequence["AnalogForwardOnly"] = self.set_subsequence_benchmarking
