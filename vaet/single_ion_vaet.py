...
class SingleIonVAET(PulseSequence):
    ...
    def run_initially(self):
        ...
        print("here: ", self.p.TrapFrequencies[self.p.SingleIonVAET.selection_sideband])
        trap_frequency = self.get_trap_frequency(self.p.SingleIonVAET.selection_sideband)
