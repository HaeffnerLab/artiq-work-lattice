...
class SZX:
    ...
    def subsequence(self):
        ...
        freq_red = 80*MHz - trap_frequency*0.5 - b.detuning
        freq_blue = 80*MHz + trap_frequency*0.5 + b.detuning + s.nu_effective
